...
local commit_drop = function(commit_hash)
    require("trunks._ui.trunks_commands").run_trunks_cmd({ args = "commit-drop " .. commit_hash })
end

describe("commit-drop command", function()
    local context
