...
function M.highlight_num_commits(bufnr, start_line, lines)
    for i, line in ipairs(lines) do
        ...
        require("trunks._ui.highlight").highlight_line(bufnr, "Keyword", line_num, pull_start, pull_end)
        local push_start, push_end = line:find("↑%d+")
        require("trunks._ui.highlight").highlight_line(bufnr, "Keyword", line_num, push_start, push_end)
    end
end
