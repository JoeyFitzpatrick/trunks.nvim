---@alias trunks.GitFiletypeOutputType "commit" | "filepath" | "previous_filepath" | "vimdiff"

---@class trunks.GitFiletypeLineData
---@field item_type trunks.GitFiletypeOutputType
---@field commit? string
...
---@return trunks.GitFiletypeOutputType
...
---@param bufnr integer
---@return trunks.GitFiletypeLineData | nil
