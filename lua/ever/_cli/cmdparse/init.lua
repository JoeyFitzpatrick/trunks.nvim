...
---
---@module 'ever._cli.cmdparse'
---

local argparse = require("ever._cli.argparse")
local argparse_helper = require("ever._cli.argparse_helper")
local configuration = require("ever._core.configuration")
local constant = require("ever._cli.cmdparse.constant")
local evaluator = require("ever._cli.cmdparse.evaluator")
local help_message = require("ever._cli.cmdparse.help_message")
local iterator_helper = require("ever._cli.cmdparse.iterator_helper")
local matcher = require("ever._cli.cmdparse.matcher")
local sorter = require("ever._cli.cmdparse.sorter")
local tabler = require("ever._core.tabler")
local text_parse = require("ever._cli.cmdparse.text_parse")
local texter = require("ever._core.texter")
local types_input = require("ever._cli.cmdparse.types_input")
...
---
---@param data ever.ConfigurationCmdparseAutoComplete?
...
---
---@param options ever.ConfigurationCmdparseAutoComplete?
---    The user settings to read from, if any. If no data is given, the user's
---    default configuration is used insteand.
