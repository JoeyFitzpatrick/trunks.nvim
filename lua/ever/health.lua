...
local say_constant = require("ever._commands.hello_world.say.constant")
...
---
---@param command string A supported `ever` command. e.g. `"hello_world"`.
---@return string[] # All found issues, if any.
---
...
---
---@param data ever.LoggingConfiguration The user's logger settings.
