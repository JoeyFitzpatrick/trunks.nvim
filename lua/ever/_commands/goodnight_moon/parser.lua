--- The main parser for the `:Ever goodnight-moon` command.
---
---@module 'ever._commands.goodnight_moon.parser'
---
...
---@return cmdparse.ParameterParser # The main parser for the `:Ever goodnight-moon` command.
function M.make_parser()
    ...
    count_sheep:set_execute(function(data)
        ...
        local count_sheep_ = require("ever._commands.goodnight_moon.count_sheep")
    ...
    read:set_execute(function(data)
        ---@cast data ever.NamespaceExecuteArguments
        local read_ = require("ever._commands.goodnight_moon.read")
    ...
    sleep:set_execute(function(data)
        ---@cast data ever.NamespaceExecuteArguments
        local sleep_ = require("ever._commands.goodnight_moon.sleep")
