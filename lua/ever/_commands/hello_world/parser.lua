--- The main parser for the `:Ever hello-world` command.
---
---@module 'ever._commands.hello_world.parser'
---

local cmdparse = require("ever._cli.cmdparse")
local constant = require("ever._commands.hello_world.say.constant")
...
---@return cmdparse.ParameterParser # The main parser for the `:Ever hello-world` command.
function M.make_parser()
    ...
    phrase:set_execute(function(data)
        ...
        local runner = require("ever._commands.hello_world.say.runner")
