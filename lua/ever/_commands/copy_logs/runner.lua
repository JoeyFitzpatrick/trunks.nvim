...
---
---@module 'ever._commands.copy_logs.runner'
---
...
---
---@param result ever.ReadFileResult The file path + its contents that we read.
---
...
---@param callback fun(result: ever.ReadFileResult): nil Call this once `path` is read.
---
