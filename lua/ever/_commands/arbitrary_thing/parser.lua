--- The main parser for the `:Ever arbitrary-thing` command.
---
---@module 'ever._commands.arbitrary_thing.parser'
---
...
---@return cmdparse.ParameterParser # The main parser for the `:Ever arbitrary-thing` command.
function M.make_parser()
    ...
    parser:set_execute(function(data)
        ...
        local runner = require("ever._commands.arbitrary_thing.runner")
